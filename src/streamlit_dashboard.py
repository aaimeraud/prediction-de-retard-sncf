...
def load_model() -> DelayClassifier:
    ...
    Returns:
        DelayClassifier: Trained model instance for delay predictions.
    """
...
@st.cache_data
def predict_batch(features_df: pd.DataFrame, classifier: DelayClassifier) -> np.ndarray:
    """
    ...
    """
    return classifier.predict(features_df.values)
